...
public class UserAdminController {
    ...
    @ApiResponse(responseCode = "409", description = "Email already registered in this tenant", content = @io.swagger.v3.oas.annotations.media.Content)
    ...
    @ApiResponse(responseCode = "404", description = "No such user in this tenant", content = @io.swagger.v3.oas.annotations.media.Content)
    ...
    @ApiResponse(responseCode = "409", description = "Would leave the tenant with no administrator", content = @io.swagger.v3.oas.annotations.media.Content)
