 ...
 *
 * <p>The default is {@link #SYSTEM_TENANT}, an id that matches no row: an unscoped thread sees
 * <em>nothing</em> rather than <em>everything</em>, so a forgotten scope is an empty result and a failing
 * test, never a cross-tenant leak.
 */
public final class TenantContext {
    ...
    /** Runs {@code action} scoped to {@code tenantId}, restoring the previous scope afterwards. */
